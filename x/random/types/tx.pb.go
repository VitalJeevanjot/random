...
type MsgCreateRandom struct {
	...
	OutputCap string `protobuf:"bytes,2,opt,name=outputCap,proto3" json:"outputCap,omitempty"`
}
...
func (m *MsgCreateRandom) GetOutputCap() string {
	if m != nil {
		return m.OutputCap
	}
	return ""
...
var fileDescriptor_8734007206ce5490 = []byte{
	...
	,
}
...
func (m *MsgCreateRandom) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.OutputCap) > 0 {
		i -= len(m.OutputCap)
		copy(dAtA[i:], m.OutputCap)
		i = encodeVarintTx(dAtA, i, uint64(len(m.OutputCap)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Creator) > 0 {
...
func (m *MsgCreateRandom) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field OutputCap", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.OutputCap = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
