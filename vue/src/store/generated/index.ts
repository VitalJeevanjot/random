...
import GenievotRandomGenievotRandomRandom from './genievot/random/genievot.random.random'
...
export default { 
  ...
  GenievotRandomGenievotRandomRandom: load(GenievotRandomGenievotRandomRandom, 'genievot.random.random'),
