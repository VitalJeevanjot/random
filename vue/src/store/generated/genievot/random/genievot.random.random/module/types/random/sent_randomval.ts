...
const baseSentRandomval: object = { id: 0, userid: "", vrv: "", creator: "" };

export const SentRandomval = {
  encode(message: SentRandomval, writer: Writer = Writer.create()): Writer {
    if (message.id !== 0) {
  ...
  decode(input: Reader | Uint8Array, length?: number): SentRandomval {
    ...
    const message = { ...baseSentRandomval } as SentRandomval;
