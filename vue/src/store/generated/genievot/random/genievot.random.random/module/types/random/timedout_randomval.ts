...
const baseTimedoutRandomval: object = { id: 0, creator: "" };

export const TimedoutRandomval = {
  encode(message: TimedoutRandomval, writer: Writer = Writer.create()): Writer {
    if (message.id !== 0) {
  ...
  decode(input: Reader | Uint8Array, length?: number): TimedoutRandomval {
    ...
    const message = { ...baseTimedoutRandomval } as TimedoutRandomval;
